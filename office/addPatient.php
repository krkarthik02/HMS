...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
  if (matchPassword()) {
    ...
    if ($num_rows) {
      ...
      $sql = "INSERT INTO `patient` (`fname`,`lname`,`username`,`email`,`address`,`city`,`state`,`pincode`,`bloodgroup`,`dob`,`phno`,`password`,`gender`,`image`,`Med_history`) VALUES ('$fname','$lname','$username','$email','$address','$city','$state','$pin','$bgroup','$dob','$phno','$password','$gender','$imagename','$med_his')";
...
<body>
  <div class="reg">
    <div class="container">
      ...
      <div class="content">
        <form action="addPatient.php" method="POST" class="form" name="form" enctype="multipart/form-data">
